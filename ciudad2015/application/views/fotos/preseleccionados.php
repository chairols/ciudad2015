...
<table width="950" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td bgcolor="#ffffff" ><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td>&nbsp;</td>
          <td class="fondoblanco interiortabla2" width="701" rowspan="346"><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td class="bienvenido">&nbsp;</td>
              </tr>
              <tr>
                <td class="bienvenido"><strong>Fotos preseleccionadas</strong></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
              </tr>
